...
namespace CarSalesPredictor_001
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Andrian Perdido\Downloads\CarSales - Sheet1.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"Year", @"Year"),new InputOutputColumnPair(@"Mileage", @"Mileage")})      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Make",outputColumnName:@"Make"))      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Model",outputColumnName:@"Model"))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Year",@"Mileage",@"Make",@"Model"}))      
